...
contract ISCToken is StandardToken {
    ...
    // metadata
    string public constant name = "iSunCloud Token";
    ...
    address public iscFundDeposit;      // deposit address for XPlay Ltd. use and ISC User Fund
    ...
    uint256 public tokenExchangeRate = 23000;   // 23000 ISC tokens per 1 ETH
    uint256 public constant tokenCreationCap =  10 * (10**9) * 10**decimals;
    uint256 public tokenCrowdsaleCap =  4 * (10**8) * 10**decimals;

    // events
    event CreateISC(address indexed _to, uint256 _value);

    // constructor
    function ISCToken(
        address _ethFundDeposit,
        address _iscFundDeposit,
        ...
        public
    {
        ...
        iscFundDeposit = _iscFundDeposit;
        tokenExchangeRate = _tokenExchangeRate;
        fundingStartBlock = _fundingStartBlock;
        fundingEndBlock = _fundingEndBlock;
        totalSupply = tokenCreationCap;
        balances[iscFundDeposit] = tokenCreationCap;    // deposit all ISC to XPlay Ltd.
        CreateISC(iscFundDeposit, tokenCreationCap);    // logs deposit of XPlay Ltd. fund
    }
    ...
    function () payable public {
        ...
        balances[msg.sender] += tokens;     // add amount of ISC to sender
        balances[iscFundDeposit] = safeSub(balances[iscFundDeposit], tokens); // subtracts amount from XPlay's balance
        CreateISC(msg.sender, tokens);      // logs token creation

    }
    /// @dev Accepts ether and creates new ISC tokens.
