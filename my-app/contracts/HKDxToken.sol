...
contract HKDxToken is StandardToken {

    // metadata
    string public constant name = "HKD token";
    string public constant symbol = "HKDx";
    uint256 public constant decimals = 18;
    string public version = "1.0";

    // contracts
    address public ethFundDeposit;
    address public hkdxFundDeposit;
    ...
    // events
    event CreateHKDx(address indexed _to, uint256 _value);

    // constructor
    function HKDxToken(
        address _ethFundDeposit,
        address _hkdxFundDeposit,
        ...
        public
    {
        ...
        hkdxFundDeposit = _hkdxFundDeposit;
        tokenExchangeRate = _tokenExchangeRate;
        fundingStartBlock = _fundingStartBlock;
        fundingEndBlock = _fundingEndBlock;
        totalSupply = tokenCreationCap;
        balances[hkdxFundDeposit] = tokenCreationCap;
        CreateHKDx(hkdxFundDeposit, tokenCreationCap);
    }
    ...
    function () payable public {
        ...
        balances[hkdxFundDeposit] = safeSub(balances[hkdxFundDeposit], tokens);
        CreateHKDx(msg.sender, tokens);

    }
    /// @dev Accepts ether and creates new HKD tokens.
